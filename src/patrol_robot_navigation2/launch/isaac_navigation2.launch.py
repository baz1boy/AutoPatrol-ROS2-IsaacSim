...
def generate_launch_description():
    ...
    rviz_config_dir = os.path.join(pabot_navigation2_dir, 'rviz2', 'pabot_navigation.rviz')
    ...
    declare_map_yaml = DeclareLaunchArgument(
        name = 'map', 
        default_value=os.path.join(pabot_navigation2_dir, 'maps', 'pabot_room_navigation.yaml'),
